...
interface HomePageContract {
    sealed interface UiState{
        data class Success(val toolBarUiState: HomePageToolBarUiState, val allProducts:List<ProductUI>,val searchProducts:List<ProductUI>):UiState
...
sealed interface HomePageToolBarUiState {
    ...
    data class Search(val searchText: String) : HomePageToolBarUiState
