package com.example.electronicsstoreapp.features.profile.authentication.presentation.viewmodel
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.example.electronicsstoreapp.features.home.domain.usecase.GetFavoritesUseCase
import com.example.electronicsstoreapp.features.profile.authentication.domain.usecase.SignInUseCase
import com.example.electronicsstoreapp.features.profile.authentication.presentation.contract.LoginContract.SideEffect
import com.example.electronicsstoreapp.features.profile.authentication.presentation.contract.LoginContract.UiAction
import com.example.electronicsstoreapp.features.profile.authentication.presentation.contract.LoginContract.UiState
        ...
        private fun onLoginClick() =
            viewModelScope.launch {
                ...
                result.onSuccess { it ->
                    ...
                    onCreateToast("Successful Login, Welcome!")
