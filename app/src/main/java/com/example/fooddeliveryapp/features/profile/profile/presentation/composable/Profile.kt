package com.example.fooddeliveryapp.features.profile.profile.presentation.composable
...
import com.example.fooddeliveryapp.features.profile.profile.presentation.viewmodel.ProfileViewModel
...
fun ProfileScreen(){
    ...
    ProfileContent(uiState,uiAction,sideEffect,viewModel)
}
                ...
                Card(
                    ...
                    Row(modifier = Modifier.fillMaxWidth()) {
                        Column(modifier = Modifier.padding(28.dp).fillMaxWidth()) {
                            Text(text = "Name: ${uiState.name}", color = Color.Black, fontSize = 12.sp, modifier = Modifier.padding(5.dp))
                            Text(text = "Email: ${uiState.email}", color = Color.Black, fontSize = 12.sp, modifier = Modifier.padding(5.dp))
                            Text(text = "Phone: ${uiState.phoneNumber}", color = Color.Black, fontSize = 12.sp, modifier = Modifier.padding(5.dp))
                        }
                    }
                }
            }
