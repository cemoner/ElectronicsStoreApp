...
import com.example.fooddeliveryapp.profile.authentication.login.presentation.viewmodel.LoginViewModel
...
fun LoginContent(uiState: UiState, onAction:(UiAction) -> Unit, sideEffect: Flow<SideEffect>){
    ...
    Column(modifier = Modifier.fillMaxSize(), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        RegOrLoginDuo(({onAction(UiAction.OnRegisterButtonClick)}),textString = "Don't have an Account?", buttonString = "Register")
    }
