...
import com.example.fooddeliveryapp.authentication.login.presentation.components.FormTextFieldContent
...
fun RegisterScreen(navController: NavController){
    ...
    RegisterContent(uiState,onAction,sideEffect,navController)
}


@Composable
fun RegisterContent(uiState: UiState, onAction: (UiAction) -> Unit, sideEffect: Flow<SideEffect>, navController: NavController){
